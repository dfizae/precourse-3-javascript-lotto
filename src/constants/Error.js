export const ERROR = Object.freeze({
    ...
    INVALID_NUMBER: "[ERROR] 로또 번호는 특수문자, 문자 외의 1과 45 사이의 정수만 허용됩니다.",
    INVALID_NUMBER_COUNT: "[ERROR] 로또 번호의 개수가 6개여야 한다.",
    INVALID_WINNING_NUMBER: "[ERROR] 당첨 번호는 특수문자, 문자 외의 1과 45 사이의 정수를 입력해야 한다.",
    INVALID_WINNING_NUMBER_COUNT: "[ERROR] 당첨 번호는 6개의 숫자로 이루어져야 한다.",
    INVALID_BONUS_NUMBER: "[ERROR] 보너스 번호는 특수문자, 문자 외의 1과 45 사이의 정수를 입력해야 한다.",
